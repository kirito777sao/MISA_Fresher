...
{
    /// <summary>
    /// DTO tạo mới ca làm việc.
    /// Chứa các trường cần thiết để tạo một bản ghi mới.
    /// </summary>
    ...
    public class WorkShiftCreateDto
    {
        ...
        [MISARequired("Thời gia kết thúc ca không được để trống")]
        ...
        /// <summary>
        /// Ngày tạo bản ghi (Mặc định là thời gian hiện tại)
        /// </summary>
        ...
        /// Người tạo bản ghi
        /// </summary>
        public string? CreatedBy { get; set; } = "HoanTD";

        [MISAColumnName("modified_date")]
        /// <summary>
        /// Ngày sửa đổi cuối cùng (Mặc định là thời gian hiện tại khi tạo)
        /// </summary>
